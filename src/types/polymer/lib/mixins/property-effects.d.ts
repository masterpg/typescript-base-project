...
declare module '@polymer/polymer/lib/mixins/property-effects' {


  import { PropertyAccessorsConstructor } from "@polymer/polymer/lib/mixins/property-accessors";
  import { TemplateStampConstructor } from "@polymer/polymer/lib/mixins/template-stamp";
   ...
   * async by default.
   */
  function PropertyEffects<T extends new (...args: any[]) => {}>(base: T): T & PropertyEffectsConstructor & TemplateStampConstructor & PropertyAccessorsConstructor;
