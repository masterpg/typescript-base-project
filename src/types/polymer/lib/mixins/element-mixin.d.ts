...
declare module '@polymer/polymer/lib/mixins/element-mixin' {


  import { PropertiesMixinConstructor } from "@polymer/polymer/lib/mixins/properties-mixin";
  import { PropertyEffectsConstructor } from "@polymer/polymer/lib/mixins/property-effects";
   ...
   */
  function ElementMixin<T extends new (...args: any[]) => {}>(base: T): T & ElementMixinConstructor & PropertyEffectsConstructor & PropertiesMixinConstructor;
